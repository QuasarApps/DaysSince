...
/**
 * Exposes app [Settings] as state and forwards edits to [SettingsRepository]. Read at the app root so
 * the theme choice can drive [com.quasarapps.pulsar.ui.theme.PulsarTheme] and the detail units row.
 */
